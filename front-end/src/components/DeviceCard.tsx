...
import { exportDeviceToExcel } from "@/lib/exportUtils";
      ...
      <CardContent className="p-0 text-white font-mono">
        ...
        <div className="p-6 border-b border-white/5 bg-gradient-to-b from-[#00e5bf]/5 to-transparent">
          <div className="flex justify-between items-start mb-6 gap-2">
            ...
            <div className="flex items-center gap-4 min-w-0">
              ...
              <div className="min-w-0">
                <h3 className="text-sm font-black tracking-widest uppercase truncate max-w-[140px] md:max-w-full">
                  {device.device_id}
                </h3>
                <span className="text-[10px] text-[#00e5bf] font-bold block">
                  {device.is_online
                    ? "TRACKING_LIVE"
            ...
            {/* RIGHT SIDE: TIME & ACTIONS (FIXED COLLAPSE) */}
            <div className="flex items-center gap-4 shrink-0">
              <div className="text-right min-w-[85px]">
                <p className="text-[9px] text-gray-500 uppercase font-bold tracking-tighter">
                  Total_Uptime
                </p>
                <p className="text-xl font-black whitespace-nowrap tabular-nums">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => exportDeviceToExcel(device)}
                  className="p-2 rounded-lg bg-[#00e5bf]/10 hover:bg-[#00e5bf]/20 border border-[#00e5bf]/50 text-[#00e5bf] transition-all shrink-0"
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-red-500/10 hover:bg-red-500/20 border border-red-500/50 text-red-500 transition-all shrink-0"
                  title="Delete Device"
                >
                  <Trash2 size={16} />
                </button>
                <button
                  ...
                  className="p-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 shrink-0"
                >
          ...
          <div className="border border-[#00e5bf]/20 bg-black/60 p-4 rounded-xl flex gap-4">
            <Layout className="text-[#00e5bf] shrink-0" />
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? "border-transparent text-[#080d10]"
